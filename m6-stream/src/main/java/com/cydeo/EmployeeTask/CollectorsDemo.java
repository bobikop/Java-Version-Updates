...
public class CollectorsDemo {
    public static void main(String[] args) {
        ...
        List<Integer> numberList = numbers.stream()
                .filter(x -> x%2 == 0)
                .collect(Collectors.toCollection(ArrayList::new));//  toCollection method belong to Collectors class   ...ArrayList::new creating new Arraylist here with constructor
